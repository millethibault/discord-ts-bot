...
function parseBattleLog(battleLogString) {
    const battleLog = battleLogString.map(item => ({
        battleTime: (0, parseBrawlStarsDate_1.default)(item.battleTime),
        event: item.event,
        battle: item.battle
    }));
    return battleLog;
 ...
 */
function getPlayerBattleLog(tag) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return parseBattleLog(response.items);
    });
}
//# sourceMappingURL=PlayerBattleLog.js.map